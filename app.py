...
if selected == "Home":
    ...
    col1.metric("Total Orders", df["Row ID"].nunique(),2)
...
#     options=["Home","Branch","City","Comparian","Data Explorer"],
#     icons=["house","star","building","bar-chart","table",],
#     orientation="horizontal"
# )
